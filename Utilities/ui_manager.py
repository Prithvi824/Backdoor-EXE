...
class UIManager:
    ...
    def type_sentence(self, sentence: str) -> str:
        ...
        try:
            ...
            for char in sentence:
                ...
                if not vk:
                    return (
                        f"Failed to type sentence: Key not found for character: {char}"
                    )
            ...
            return f"Sentence typed: {sentence}"

        except Exception as e:
            return f"Failed to type sentence: {e}"
    ...
    def click_x_y(self, x: int, y: int, left: bool = True) -> str:
        ...
        if left:
            self.left_click(x, y)
            return f"Left click performed at cords ({x}, {y})"
        else:
            self.right_click(x, y)
            return f"Right click performed at cords ({x}, {y})"
    ...
    def scroll_mouse(self, scroll_power: int) -> str:
        ...
        try:
            ...
            return f"Failed to scroll mouse: {e}"
    ...
    def switch_tab(self) -> str:
        ...
        try:
            ...
            return f"Failed to switch to the next tab: {e}"
    ...
    def handle_command(self, command: List[str]) -> str:
        ...
        if command[0] == ShellCommands.LEFT_CLICK.value:
            ...
            return f"Invalid command for ui manager. Provided command: {command}"
